...
<div class="con">
    ...
    <div class="btns">
        ...
        <input class="w3-bar-item w3-button" type="button" value="Weather of today" onclick="xgettoday()">

        <input class="w3-bar-item w3-button" type="button" value="Weather next 05 days" onclick="xget()">
    </div>
