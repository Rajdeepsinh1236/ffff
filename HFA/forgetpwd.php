    ...
    <form class="form" action="" method="post">
        <table class="tbl" align="center" cellspacing=30>
            <tr>
                ...
                <td>
                    <input class="w3-input" type="text" name="email" value="<?= $value ?>" placeholder="Enter your recovery Email">
                </td>
            </tr>
            <?php
            if ($_POST) {
            ...
            ?><tr>
                <td colspan="2" align=center>
                    <input type="submit" class="w3-button w3-white w3-border w3-border-black" value="Submit" name="submit">
                    <a href="login.php"><input class="w3-button w3-white w3-border w3-border-black" type="button" value="Back"></a>
                </td>
            </tr>
        </table>
    </form>
