    ...
    <div class="container">
        ...
        <form class="form" method="post" action="logincheck.php">
            ...
            <table align=center cellspacing=30 class="tbl">
                <tr>
                    <td>Username</td>
                    <td><input class="w3-input" type="text" name="username" placeholder="Enter username" required></td>
                </tr>
                <tr>
                    <td>Password</td>
                ...
                <tr>
                    <td colspan=2> <input class="w3-button w3-white w3-border w3-border-black" type="submit" value="Submit" name="submit">
                        <input class="w3-button w3-white w3-border" type="reset" value="Clear" name="clear">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">Don't have account?<br><br><a href="signup.php"><input class="w3-button w3-white w3-border w3-border-black w3-round-large" type="button" value="Register"></a></td>
                </tr>
                <tr>
                    <td colspan="2"><a href="forgetpwd.php">forget username/password?</a></td>
                </tr>
                <tr>
                    <td colspan="2" style="color:black"><?php
                                                        if (isset($_GET["err"])) {
                                                            echo $_GET["err"];
                                                        } ?></td>
                </tr>
