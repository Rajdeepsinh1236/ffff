...
<div class="instructions">
    ...
    <ul class="pronly">
        <li> if you want to <strong>search by state</strong> then you must<strong> check the checkbox</strong> at after the text and if you want search by both then select both.</li>
        <li> if you want <strong>all the record</strong> you can direct click on <strong>Get Data</strong> button.</li>
        <li> Please enter the values with <strong>first letter capital.</strong></li>
    </ul>
    <hr>
    </p>
    <p align=center>
    <table align=center cellspacing=20>
        <tr>
            ...
            <td><input class="w3-input" type="text" name="search" placeholder="Name of commodity" id="commodity"></td>
        </tr>
        <tr>
            <td><input type="checkbox" id="c_state">Search by State : </td>
            <td><input class="w3-input" type="text" name="search" placeholder="Name of State" id="state"></td>
        </tr>
        <tr>
